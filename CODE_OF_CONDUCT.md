## Code of Conduct for Contributing to dj-announcement-api

we’re thrilled that you want to contribute to `dj-announcement-api`! to ensure a positive and protective environment for everyone involved, please adhere to the following guidelines.

## Contribution Workflow

1. **Fork and Clone**: Start by forking the `dj-announcement-api` repository on Github and cloning it to your local machine:
    ```bash
    git clone https://github.com/lazarus-org/dj-announcement-api.git
...
Thank you for contributing to `dj-announcement-api`! We look forward to your contributions.
