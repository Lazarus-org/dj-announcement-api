...
class AnnouncementDataAccessLayer(Manager):
    ...
    This class provides an interface for retrieving and manipulating Announcement
    objects by utilizing custom methods defined in the AnnouncementQuerySet.
    """

    def get_queryset(self) -> AnnouncementQuerySet:
        """
        Override the default get_queryset method to return an AnnouncementQuerySet instance.
    ...
    def upcoming(self) -> QuerySet:
        """
        Retrieves announcements that are scheduled to be published in the future.
